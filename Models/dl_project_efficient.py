...
base_model = tf.keras.applications.EfficientNetV2B3(input_shape = image_shape,
                                                    include_top = False,
                                                    weights = 'imagenet')
...
checkpoint_filepath = '/home/cew4pf/dl_project/tmp/eff_checkpoint'
...
model.load_weights('/home/cew4pf/dl_project/tmp/eff_checkpoint')
...
#!mkdir -p saved_model
model.save('/home/cew4pf/dl_project/tmp/eff_model')
